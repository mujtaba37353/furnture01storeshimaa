...
} from "../../api/subSubCategories.api.js";
import SubSubModal from "./SubSubModal.jsx";

function SubCategoryShowSubSubCategoryModal({ open, setOpen, subcategory }) {
  const { role } = useSelector((state) => state.user);

  const [removeRrand, { isLoading: removeBrandLoading }] =
    useRemoveRrandMutation();
  const { data, error, isSuccess } = useGetSubSubCategoriesQuery(
...
export default SubCategoryShowSubSubCategoryModal;
