...
} from "../../api/brands.api.js";
import SubBrandModal from "./subBrandModal.jsx";

function SubCategoryShowBrandModal({ open, setOpen, subcategory }) {
  const { role } = useSelector((state) => state.user);

  const [removeRrand, { isLoading: removeBrandLoading }] =
    useRemoveRrandMutation();
  const { data, error, isSuccess } = useGetBrandsQuery(
  ...
  const [openUpdateBrand, setOpenUpdateBrand] = React.useState(false);
  ...
  return (
    ...
    >
      <SubBrandModal
        open={openUpdateBrand}
        setOpen={setOpenUpdateBrand}
        brand={selectBrand}
      />
      <Stack>
        <Typography sx={{ color: colors.main }}>
          {language === "en" ? "Sub sub categories" : "الأقسام الفرعية الفرعية"}
        </Typography>
      </Stack>
      <Divider
                    ...
                    >
                      ...
                      >
                        {language === "en"
                          ...
                          : "لا يوجد أقسام فرعية فرعية فرعية"}
                      </Typography>
                    </Box>
                  </TableCell>
                </TableRow>
                  ...
                  data.data.map((subcategory, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell align="center">
                        ...
                        >
                          {/* Delete and Edit Brand */}
                          {allowed({ page: "brands", role }) ? (
                            <Box
                              sx={{
                                display: "flex",
                                direction: "row",
                            ...
                            >
                              ...
                              >
                                <Button
                                  ...
                                  onClick={() =>
                                    handleDeleteBrand(subcategory._id)
                                  }
...
export default SubCategoryShowBrandModal;
